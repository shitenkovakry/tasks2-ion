...
func SpiralOrder(array [][]int, spiralArgument SpiralArgument) []int {
	...
	if spiralArgument.Direction == CounterClockwiseFrom0N {
		return SpiralCounterClockwiseFrom0N(array)
	}
	...
	if spiralArgument.Direction == ClockwiseFromNN {
		return SpiralClockwiseFromNN(array)
	}

	if spiralArgument.Direction == CounterClockwiseFromNN {
		return SpiralCounterClockwiseFromNN(array)
	}
...
func SpiralCounterClockwiseFrom0N(array [][]int) []int {
	left := 0
	right := len(array) - 1
	result := []int{}
	...
	for index := 0; index <= len(array)/2; index++ {
		if left > 0 {
			result = append(result, Walk(array, left, right+1, left, left)...)
		} else {
		...
		if right != left {
			result = append(result, Walk(array, right, left, right, right)...)
			result = append(result, Walk(array, right, right, left+1, right)...)
		}
...
func SpiralClockwixseFromN0(array [][]int) []int {
	left := 0
	right := len(array) - 1
	result := []int{}
	...
	for index := 0; index <= len(array)/2; index++ {
		if left > 0 {
			result = append(result, Walk(array, right+1, left, left, left)...)
		} else {
			result = append(result, Walk(array, right, left, left, left)...)
		}
...
func SpiralClockwiseFromNN(array [][]int) []int {
	left := 0
	right := len(array) - 1
	result := []int{}
	...
	for index := 0; index <= len(array)/2; index++ {
		if left > 0 {
			result = append(result, Walk(array, right, right+1, right, left)...)
		} else {
			result = append(result, Walk(array, right, right, right, left)...)
		}
		...
		if right != left {
			result = append(result, Walk(array, left, left, left, right)...)
			result = append(result, Walk(array, left, right, right-1, right)...)
		}
...
func SpiralCounterClockwiseFromNN(array [][]int) []int {
	left := 0
	right := len(array) - 1
	result := []int{}
	...
	for index := 0; index <= len(array)/2; index++ {
		if left > 0 {
			result = append(result, Walk(array, right+1, right, left, right)...)
		} else {
			result = append(result, Walk(array, right, right, left, right)...)
		}
		...
		if right != left {
			result = append(result, Walk(array, left, left, right, left)...)
			result = append(result, Walk(array, right, left, right, right-1)...)
		}
